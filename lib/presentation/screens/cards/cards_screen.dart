    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          //colocarlo cuando falte un poco mas de espacio a lo ulitmo
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child:  Padding(
        ...
        child: Column(
          children: [
            //el align ocupa todo el espacio de la pantalla de manera horizontal
            Align(
              //el alignment mueve todo lo que esta dentro de la card
...
class _CardType4 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      //evita que los hijos salga de su padre
          ...
          Align(
            ...
            child: Container(
              decoration: const BoxDecoration(
                color: Colors.white,
                //solo en la parte derecha de conteines
